      ...
      <div>
        ...
        <ul className="sidebar-menu">
          ...
          <li>
            <a 
              href="#telemetry" 
              className={`menu-item ${currentTab === 'live-data' ? 'active' : ''}`}
              onClick={(e) => handleItemClick(e, 'live-data')}
            >
          ...
          <li>
            <a 
              href="#fields" 
              className={`menu-item ${currentTab === 'fields' ? 'active' : ''}`}
              onClick={(e) => handleItemClick(e, 'fields')}
            >
          ...
          <li>
            <a 
              ...
              className={`menu-item ${currentTab === 'recommendations' ? 'active' : ''}`}
              onClick={(e) => handleItemClick(e, 'recommendations')}
            >
          ...
          <li>
            <a 
              href="#crop" 
              className={`menu-item ${currentTab === 'crop-suggestion' ? 'active' : ''}`}
              onClick={(e) => handleItemClick(e, 'crop-suggestion')}
            >
          ...
          <li>
            <a 
              href="#fertilizer" 
              className={`menu-item ${currentTab === 'fertilizer-suggestion' ? 'active' : ''}`}
              onClick={(e) => handleItemClick(e, 'fertilizer-suggestion')}
            >
          ...
          <li>
            <a 
              href="#irrigation" 
              className={`menu-item ${currentTab === 'irrigation-advisor' ? 'active' : ''}`}
              onClick={(e) => handleItemClick(e, 'irrigation-advisor')}
            >
          ...
          <li>
            <a 
              ...
              onClick={(e) => handleItemClick(e, 'alerts')}
            >
